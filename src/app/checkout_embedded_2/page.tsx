  ...
  useEffect(() => {
    ...
    const initializeMollie = () => {
      ...
      const options = {
        ...
        components: {
          cardHolder: {
            label: "Cardholder name bitte",
          },
          cardNumber: {
            label: "cardNumber bitte",
          },
          verificationCode: {
            label: "verificationCode bitte",
          },
          expiryDate: {
            label: "expiryDate bitte",
          },
        },
      };
    ...
    try {
      ...
      const response = await fetch("/api/payments", {
        ...
        headers: {
          ...
          "Authorization": `Bearer access_CjgPkr9sE6ysyhqTaPMHhWwWTWqMU7`,
        },
        body: JSON.stringify({
          cardToken: token,
          amount: {
          ...
          description: "Friendly embedded Payment for socks",
...
export default CheckoutEmbedded2;